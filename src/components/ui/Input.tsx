...
function Input<OutputType>(
  { className, placeholder, transform, hideValue = false }: IInputProps<OutputType>,
...
export default forwardRef(Input) as <OutputType>(
  props: IInputProps<OutputType> & { ref?: MutableRefObject<HTMLInputElement> }
) => JSX.Element;
