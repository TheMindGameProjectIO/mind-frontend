    ...
    <div className="flex items-center justify-center bg-center bg-cover bg-contact-us-background font-play pt-10 pb-10">
      <div className="bg-transparent-blue flex flex-col md:flex-row rounded-xl md:w-3/4 md:max-w-3xl">
        <div className="flex flex-col mt-9 md:mt-6 md:ml-10 text-center md:min-w-max md:text-left items-center md:items-start">
          ...
          <h2 className="text-cr-gray text-[1.5rem] md:text-[1.4rem] md:mb-4 md:mt-2">
            Need to get in <br className="hidden md:block" /> touch with us?
          </h2>
          <h2 className="text-cr-gray text-[1.5rem] md:text-[1.4rem]">
            Fill out the form <br className="hidden md:block" />
            with your inquiry.
          </h2>
        </div>
        ...
        <form className="contactus" onSubmit={onSubmit}>
          <div className="flex flex-col md:flex-row mt-5">
            ...
            {error === "empty first name" && window.innerWidth < 768 ? (
              <InputError> Please, provide your first name </InputError>
            ) : null}

            <Input<string> className={inputClassName} placeholder="Last name" ref={lastNameRef} />
            {error === "empty last name" && window.innerWidth < 768 ? (
              <InputError> Please, provide your last name </InputError>
            ) : null}
          </div>
          ...
          <div>
            ...
            <textarea
              className={inputClassName + " resize-none w-full placeholder-placeholder-color pt-2 pl-2 h-20"}
            ...
            {error === "something is wrong" ? (
              <InputError> Something went wrong, please try again later. </InputError>
            ) : null}
