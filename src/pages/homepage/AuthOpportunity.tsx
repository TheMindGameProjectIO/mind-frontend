...
const AuthOpportunity = () =>
{
	...
	<div className = "bg-center bg-cover bg-mind-game-background flex flex-col items-center justify-center text-center font-play">
		...
		{ /* TODO: Buttons must glow */}
		<LinkButton path = "/auth" text = "Log in" classname = 'bg-main-light rounded-[30px] w-24 m-4' />
		<LinkButton path = "/auth/signup" text = "Sign up" classname = 'bg-main-light rounded-[30px] w-24 mb-16' />
	</div>
  )
}
