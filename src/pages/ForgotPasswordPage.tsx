        ...
        <div className='h-screen flex items-center justify-center bg-center bg-cover bg-mind-game-background font-play'>
            <div className='md:flex gap-12'>
                <div className='p-6 md:mb-0'>
                    <GameTitle />
                    <h2 className='text-main-gray text-center md:text-left text-[1.5rem] md:text-[2rem] md:max-w-[200px]'> We have your back</h2>
                </div>
                ...
                <form className='forgotPassword' onSubmit={onSubmit}>
                    ...
                    <h3 className='text-little-white text-center md:text-left px-12 mt-4 mb-12'> We'll send you an email with a link that
                    ...
                    <div className="px-12">
                        ...
                        <div className='w-full flex flex-col justify-center'>
                            ...
                            <p className="text-little-white text-center mt-4"> Go back to <PageLink className='text-main-light font-bold underline mt-4' to={authRoutes.index}> login </PageLink> </p>
                        </div>
                    </div>
                </form>
            </div>
